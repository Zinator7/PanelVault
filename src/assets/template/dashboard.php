<?php
// FICHIER MODÈLE (TEMPLATE) - À NE PAS UTILISER DIRECTEMENT
// Les vraies pages sont dans src/php/pages_users/

$user = ['username' => 'Pseudo', 'level' => 1];
$niveau = 1;
$xp_totale = 0;
$pourcentage_barre = 0;
$xp_progression_niveau = 0;
$xp_par_palier = 1000;
?>
<!DOCTYPE html>
<html lang="fr">
        ...
        <aside class="dashboard-sidebar">
            <div class="user-profile">
                ...
                <div class="profile-details">
                    ...
                    <span class="xp-next-level"><?php echo $xp_progression_niveau; ?> / <?php echo $xp_par_palier; ?> XP → Lvl. <?php echo ($niveau + 1); ?></span>
                </div>
            </div>
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card reveal">
                        ...
                        <span class="stat-value">
                            <span class="ctr" data-target="<?php 
                                if (isset($user['streak'])) { echo $user['streak']; } else { echo 0; } 
                            ?>">0</span> 
                            jours
                        </span>
