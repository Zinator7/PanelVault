...
// --- CALCULS DES STATISTIQUES POUR L'AFFICHAGE ---

// 1. Récupération de l'XP totale
if (isset($user['xp'])) {
    $xp_totale = $user['xp'];
} else {
    $xp_totale = 0;
...
// 2. Récupération du niveau actuel
if (isset($user['level'])) {
    $niveau = $user['level'];
} else {
    $niveau = 1;
...
// Pour l'affichage, on définit aussi $user_level car il est utilisé plus bas dans ton HTML
$user_level = $niveau;

// 3. Calcul de la progression de niveau
$xp_par_palier = 1000;
$xp_seuil_actuel = ($niveau - 1) * $xp_par_palier;
$xp_gagnee_niveau_actuel = $xp_totale - $xp_seuil_actuel;

// Calcul du pourcentage de la barre
$pourcentage_barre = ($xp_gagnee_niveau_actuel / $xp_par_palier) * 100;

// On bloque à 100% maximum pour éviter que la barre dépasse
if ($pourcentage_barre > 100) {
    $pourcentage_barre = 100;
}

// On gère le cas où le pourcentage est négatif (sécurité)
if ($pourcentage_barre < 0) {
    $pourcentage_barre = 0;
}

// 4. Formatage de la date d'inscription
$membre_depuis = "Inconnu";
if (isset($user['created_at'])) {
    $objet_date = new DateTime($user['created_at']);
    $membre_depuis = date_format($objet_date, 'd M. Y');
}
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <aside class="dashboard-sidebar">
      <div class="user-profile">
        ...
        <div class="profile-details">
          ...
          <span class="profile-level">Lvl. <?php echo $user_level; ?></span>
          <div class="xp-bar-wrap">
            <div class="xp-bar" style="--xp-w: <?php echo $pourcentage_barre; ?>%"></div>
          </div>
          <span class="xp-next-level"><?php echo $xp_gagnee_niveau_actuel; ?> / <?php echo $xp_par_palier; ?> XP → Lvl. <?php echo ($niveau + 1); ?></span>
        </div>
      </div>
    ...
    <div class="dashboard-content">
      ...
      <div class="profile-hero">
        ...
        <div class="profile-avatar-wrap">
          ...
          <svg class="profile-ring" viewBox="0 0 136 136">
            ...
            <circle class="ring-fg" cx="68" cy="68" r="62" data-progress="<?php echo ($pourcentage_barre / 100); ?>"/>
          </svg>
        ...
        <div class="profile-info">
          ...
          <p class="profile-tagline">Lecteur passionné · Collectionneur de scans rares · Membre depuis le <?php echo $membre_depuis; ?></p>
          <div class="profile-pills">
            <span class="profile-pill accent">🔥 <?php if(isset($user['streak'])) { echo $user['streak']; } else { echo 0; } ?> jours de streak</span>
      ...
      <section class="section">
        ...
        <div class="profile-stats-grid">
          ...
          <div class="stat-card reveal">
            <span class="stat-icon">🔥</span>
            <span class="stat-value"><span class="ctr" data-target="<?php if(isset($user['streak'])) { echo $user['streak']; } else { echo 0; } ?>">0</span> j.</span>
        ...
        <div class="progression-grid">
          ...
          <div class="level-progress-card reveal">
            ...
            <div class="lp-bar-wrap">
              <div class="lp-bar" style="--lp-w: <?php echo $pourcentage_barre; ?>%"></div>
            </div>

            <div class="lp-xp-row">
              <span><strong><?php echo $xp_gagnee_niveau_actuel; ?> XP</strong> obtenus</span>
              <span>encore <strong><?php echo ($xp_par_palier - $xp_gagnee_niveau_actuel); ?> XP</strong></span>
            </div>

            <div class="lp-meta">
              <div class="lp-meta-row">📅 <span>Membre depuis <strong><?php echo $membre_depuis; ?></strong></span></div>
          ...
          <div class="streak-wrap reveal">
            <div class="streak-header">
              ...
              <div class="streak-count">
                <span class="streak-count-num">🔥 <?php if(isset($user['streak'])) { echo $user['streak']; } else { echo 0; } ?></span>
